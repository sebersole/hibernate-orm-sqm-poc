 ...
 */
package org.hibernate.type.proposed.spi.descriptor.java;
...
import org.hibernate.type.proposed.spi.descriptor.sql.SqlTypeDescriptorRegistry;
...
public class CalendarTypeDescriptor extends AbstractTypeDescriptor<Calendar> {
	...
	public static class CalendarMutabilityPlan extends org.hibernate.type.proposed.spi.descriptor.java.MutableMutabilityPlan<Calendar> {
	...
	public String toString(Calendar value) {
		return org.hibernate.type.proposed.spi.descriptor.java.DateTypeDescriptor.INSTANCE.toString( value.getTime() );
	}

	public Calendar fromString(String string) {
		Calendar result = new GregorianCalendar();
		result.setTime( org.hibernate.type.proposed.spi.descriptor.java.DateTypeDescriptor.INSTANCE.fromString( string ) );
		return result;
	}
	...
	public SqlTypeDescriptor getJdbcRecommendedSqlType(JdbcRecommendedSqlTypeMappingContext context) {
		return SqlTypeDescriptorRegistry.INSTANCE.getDescriptor( Types.TIMESTAMP );
	}
