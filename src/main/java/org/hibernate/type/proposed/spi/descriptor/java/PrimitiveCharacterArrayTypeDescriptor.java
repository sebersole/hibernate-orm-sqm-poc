...
public class PrimitiveCharacterArrayTypeDescriptor extends AbstractTypeDescriptor<char[]> {
	...
	protected PrimitiveCharacterArrayTypeDescriptor() {
		super( char[].class, org.hibernate.type.proposed.spi.descriptor.java.ArrayMutabilityPlan.INSTANCE );
	}
	...
	public SqlTypeDescriptor getJdbcRecommendedSqlType(JdbcRecommendedSqlTypeMappingContext context) {
		return org.hibernate.type.proposed.spi.descriptor.java.CharacterArrayTypeDescriptor.INSTANCE.getJdbcRecommendedSqlType( context );
	}
