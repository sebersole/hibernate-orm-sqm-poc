...
public class BigIntTypeDescriptor implements SqlTypeDescriptor {
	...
	public JavaTypeDescriptor getJdbcRecommendedJavaTypeMapping() {
		return JavaTypeDescriptorRegistry.INSTANCE.getDescriptor( Long.class );
	}
	...
	public <X> ValueExtractor<X> getExtractor(final JavaTypeDescriptor<X> javaTypeDescriptor) {
		return new org.hibernate.type.proposed.spi.descriptor.sql.BasicExtractor<X>( javaTypeDescriptor, this ) {
			@Override
