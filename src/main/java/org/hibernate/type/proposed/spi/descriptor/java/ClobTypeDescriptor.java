...
public class ClobTypeDescriptor extends AbstractTypeDescriptor<Clob> {
	...
	@Override
	public org.hibernate.type.proposed.spi.descriptor.sql.SqlTypeDescriptor getJdbcRecommendedSqlType(JdbcRecommendedSqlTypeMappingContext context) {
		final int jdbcCode;
		...
		return org.hibernate.type.proposed.spi.descriptor.sql.SqlTypeDescriptorRegistry.INSTANCE.getDescriptor( jdbcCode );
	}
