...
/**
 * Describes the mutability aspects of a Java type; provides access to functionality that depends
 * on whether the Java type's internal state is mutable or not.
 *
