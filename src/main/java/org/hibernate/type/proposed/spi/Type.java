 ...
 */
public interface Type extends org.hibernate.sqm.domain.Type {
	/**
	...
	// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	// Consolidate these into one method?
	//		* for getColumnSpan / sqlTypes that could be SqlTypeDescriptor[]
	//		* dictatedSizes / defaultSizes is site-specific (specific to each value, rather than associated with the Type)
	//
	// maybe a SqlMapping[] or SqlColumnMapping[]?
