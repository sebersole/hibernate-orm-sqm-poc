...
public class StringTypeDescriptor extends AbstractTypeDescriptor<String> {
	...
	public SqlTypeDescriptor getJdbcRecommendedSqlType(JdbcRecommendedSqlTypeMappingContext context) {
		...
		return SqlTypeDescriptorRegistry.INSTANCE.getDescriptor( jdbcTypeCode );
	}
	...
	public <X> X unwrap(String value, Class<X> type, WrapperOptions options) {
		...
		if ( org.hibernate.type.proposed.spi.descriptor.java.DataHelper.isNClob( type ) ) {
	...
	public <X> String wrap(X value, WrapperOptions options) {
		...
		if ( Reader.class.isInstance( value ) ) {
			return org.hibernate.type.proposed.spi.descriptor.java.DataHelper.extractString( (Reader) value );
		}
		if ( Clob.class.isInstance( value ) ) {
			return org.hibernate.type.proposed.spi.descriptor.java.DataHelper.extractString( (Clob) value );
		}
