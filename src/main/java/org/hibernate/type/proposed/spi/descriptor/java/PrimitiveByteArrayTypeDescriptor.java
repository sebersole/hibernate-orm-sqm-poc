...
public class PrimitiveByteArrayTypeDescriptor extends AbstractTypeDescriptor<byte[]> {
	...
	public PrimitiveByteArrayTypeDescriptor() {
		super( byte[].class, org.hibernate.type.proposed.spi.descriptor.java.ArrayMutabilityPlan.INSTANCE );
	}
	...
	public SqlTypeDescriptor getJdbcRecommendedSqlType(JdbcRecommendedSqlTypeMappingContext context) {
		return org.hibernate.type.proposed.spi.descriptor.java.ByteArrayTypeDescriptor.INSTANCE.getJdbcRecommendedSqlType( context );
	}
