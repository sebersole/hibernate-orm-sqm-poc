...
public abstract class ClobTypeDescriptor implements SqlTypeDescriptor {
	...
	protected abstract <X> org.hibernate.type.proposed.spi.descriptor.sql.BasicBinder<X> getClobBinder(org.hibernate.type.proposed.spi.descriptor.java.JavaTypeDescriptor<X> javaTypeDescriptor);

	@Override
	public <X> ValueBinder<X> getBinder(org.hibernate.type.proposed.spi.descriptor.java.JavaTypeDescriptor<X> javaTypeDescriptor) {
	...
	public static final ClobTypeDescriptor DEFAULT = new ClobTypeDescriptor() {
		...
		public org.hibernate.type.proposed.spi.descriptor.java.JavaTypeDescriptor getJdbcRecommendedJavaTypeMapping() {
			return org.hibernate.type.proposed.spi.descriptor.java.JavaTypeDescriptorRegistry.INSTANCE.getDescriptor( Clob.class );
		}

		@Override
		public <X> org.hibernate.type.proposed.spi.descriptor.sql.BasicBinder<X> getClobBinder(final org.hibernate.type.proposed.spi.descriptor.java.JavaTypeDescriptor<X> javaTypeDescriptor) {
	...
	public static final ClobTypeDescriptor STREAM_BINDING = new ClobTypeDescriptor() {
		@Override
		public org.hibernate.type.proposed.spi.descriptor.java.JavaTypeDescriptor getJdbcRecommendedJavaTypeMapping() {
			return org.hibernate.type.proposed.spi.descriptor.java.JavaTypeDescriptorRegistry.INSTANCE.getDescriptor( String.class );
		}
