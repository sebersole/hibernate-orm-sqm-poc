...
public class CalendarTimeTypeDescriptor extends AbstractTypeDescriptor<Calendar> {
	...
	protected CalendarTimeTypeDescriptor() {
		super( Calendar.class, org.hibernate.type.proposed.spi.descriptor.java.CalendarTypeDescriptor.CalendarMutabilityPlan.INSTANCE );
	}
	...
	public SqlTypeDescriptor getJdbcRecommendedSqlType(JdbcRecommendedSqlTypeMappingContext context) {
		return SqlTypeDescriptorRegistry.INSTANCE.getDescriptor( Types.TIME );
	}
