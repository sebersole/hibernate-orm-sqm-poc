...
public class PolymorphicEntityReferenceImpl implements PolymorphicEntityReference {
	...
	private final Map<String,AbstractAttribute> attributeDescriptorMap = new HashMap<>();
	...
	public PolymorphicEntityReferenceImpl(
		...
		attr_loop: for ( AbstractAttribute attributeDescriptor : firstImplementor.getAttributeMap().values() ) {
