 ...
 */
public class QueryInterpretationsTestImpl implements QueryInterpretations {
	/**
	 * Singleton access
	 */
	public static final QueryInterpretationsTestImpl INSTANCE = new QueryInterpretationsTestImpl();
