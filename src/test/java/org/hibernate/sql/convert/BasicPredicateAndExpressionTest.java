...
public class BasicPredicateAndExpressionTest extends BaseUnitTest {
	...
	public void testBetweenLiterals() {
		SelectQuery query = interpretSelectQuery( "select p.id from Person p where p.age between 20 and 39" ).getSqlSelectAst();
	...
	public void testBetweenParams() {
		SelectQuery query = interpretSelectQuery( "select p.id from Person p where p.age between :lower and :upper" ).getSqlSelectAst();
	...
	public void testInListOfLiterals() {
		SelectQuery query = interpretSelectQuery( "select p.id from Person p where p.age in (20, 30, 40, 50, 60)" ).getSqlSelectAst();
	...
	public void testInListOfParameters() {
		SelectQuery query = interpretSelectQuery( "select p.id from Person p where p.age in (:first, :second, :third)" ).getSqlSelectAst();
	...
	public void testLike() {
		SelectQuery query = interpretSelectQuery( "select p.id from Person p where p.name.last like :name" ).getSqlSelectAst();
	...
	public void testNamedParameterCreatesUniqueInstances() {
		SelectQuery query = interpretSelectQuery( "select p.id from Person p where p.name.last = :name or p.name.last = :name" ).getSqlSelectAst();
	...
	public void testBinaryArithmeticInSelect() {
		SelectQuery query = interpretSelectQuery( "select p.age+1 from Person p" ).getSqlSelectAst();
	...
	public void testAvgInSelect() {
		SelectQuery query = interpretSelectQuery( "select avg(p.age) from Person p" ).getSqlSelectAst();
	...
	public void testCountInSelect() {
		SelectQuery query = interpretSelectQuery( "select count(p.age) from Person p" ).getSqlSelectAst();
	...
	public void testCountStarInSelect() {
		SelectQuery query = interpretSelectQuery( "select count(*) from Person p" ).getSqlSelectAst();
	...
	public void testMaxInSelect() {
		SelectQuery query = interpretSelectQuery( "select max(p.age) from Person p" ).getSqlSelectAst();
	...
	public void testMinInSelect() {
		SelectQuery query = interpretSelectQuery( "select min(p.age) from Person p" ).getSqlSelectAst();
	...
	public void testSumInSelect() {
		SelectQuery query = interpretSelectQuery( "select sum(p.age) from Person p" ).getSqlSelectAst();
